...
define(['pagination', 'jlazyload'], function() {
    return {
        init: function() {
            ...
            //1.渲染列表页面
            $.ajax({
                url: 'http://10.31.161.103/dashboard/liangcang/src/php/listdata.php',
                dataType: 'json'
                ...
                $.each(data, function(index, value) {
                    $strhtml += `
                        <li class="list-li">
                            <a href="detail.html?sid=${value.sid}" class="list-a">
                                <img class="lazy" data-original="${value.url}" class="list-img"/>
